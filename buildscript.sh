...
sleep 2
cp ~/mygit/bloat-zip/updater-script ~/mygit/bloat-zip/flounder/META-INF/com/google/android/updater-script
echo "done"

#hlte
echo "Copying updater script to hlte"
sleep 2
cp ~/mygit/bloat-zip/updater-script ~/mygit/bloat-zip/hlte/META-INF/com/google/android/updater-script
echo "done"

#klte
echo "Copying updater script to klte"
sleep 2
cp ~/mygit/bloat-zip/updater-script ~/mygit/bloat-zip/klte/META-INF/com/google/android/updater-script
echo "done"

#mako
echo "Copying updater script to mako"
sleep 2
cp ~/mygit/bloat-zip/updater-script ~/mygit/bloat-zip/mako/META-INF/com/google/android/updater-script
echo "done"
